...
const PrivacyPolicy = () => {
	return (
		<div className="PrivacyPolicyContainer">
			<div className="navbarViewer">navbar viewer</div>
			...
			<ul>
				...
				<li>
					<p>
						...
						this Agreement) refers to Kharagpur Data Analytics Group, IIT
						Kharagpur.
					</p>
				</li>
				<li>
			...
			<p>
				Cookies are small text files that are stored on your device (computer or
				mobile device) when you visit certain websites. They are used to
				remember your preferences, login information, or to track your activity
				on the website to provide a better user experience. There are different
				types of cookies:
			</p>
			<ul>
				<li>
					<strong>Session Cookies:</strong> These are temporary cookies that
					expire when you close your browser. They are used to maintain session
					state during your visit to a website.
				</li>
				<li>
				...
				<li>
					...
					website you are visiting, and they can only be read by that website.
				</li>
				<li>
					<strong>Third-Party Cookies:</strong> These are cookies set by domains
					other than the one you are visiting, usually for tracking or
					advertising purposes.
				</li>
			</ul>

			<p>
				Currently, <strong>our Service does not use Cookies</strong> or similar
				tracking technologies to collect or store information. We prioritize
				user privacy and have chosen not to track your activity or store any
				unnecessary data at this time.
			</p>

			<p>
				However, we may introduce Cookies in future versions of the Service to
				enhance functionality, improve user experience, or for other operational
				reasons. If we decide to implement Cookies, we will provide clear
				notification to all users, update our privacy policy accordingly, and
				offer an option to manage your cookie preferences.
			</p>
			...
			<ul>
				...
				<li>
					...
					information for any other purpose <strong>with Your consent.</strong>
				</li>
			</ul>
			<h3>Retention of Your Personal Data</h3>
			<p>
				Kharagpur Data Analytics Group will retain Your Personal Data only for
			...
			<p>
				Kharagpur Data Analytics Group will also retain Usage Data for internal
			...
			<p>
				If Kharagpur Data Analytics Group is involved in a merger, acquisition
			...
			<p>
				Under certain circumstances, Kharagpur Data Analytics Group may be
			...
			<p>
				Kharagpur Data Analytics Group may disclose Your Personal Data in the
				good faith belief that such action is necessary to:
			</p>
			<ul>
				<li>Comply with a legal obligation</li>
				<li>
					Protect and defend the rights or property of Kharagpur Data Analytics
					Group
				</li>
				<li>
			...
			<ul>
				<li>By email: iitkgpkdag@gmail.com</li>
			</ul>
			<div className="FooterViewer">Footer viewer</div>
		</div>
	);
};
